            ...
            <ImageBackground source={require('../assets/Pattern.png')} style={styles.V_background}>
                ...
                <View style={styles.V_home}>
                    ...
                    <View style={{ marginVertical: 15, flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontSize: fsize.size15, fontWeight: 'bold', }}>Your Cart</Text>
                        <Pressable onPress={() => { emptyCartConst() }}>
                            <Text style={{ fontSize: fsize.size12, fontWeight: 'normal', color: colors.orange }}>Delete All?</Text>
                        </Pressable>
                    </View>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => {
                            ...
                            return (
                                <View style={styles.B_foodmenu}>
                                    <Image source={item.image}></Image>
                                    <View style={{ flex: 1 }}>
                                        <Text style={{ marginHorizontal: 10, fontSize: fsize.size16, fontWeight: 'bold' }}>{item.title}</Text>
                                        <Text style={{ marginHorizontal: 10 }}>{item.restaurant}</Text>
                                    </View>
                                    ...
                                    <View>
                                        ...
                                        <Pressable onPress={() => {
                                            removeData(item)
                                        }} style={{ backgroundColor: colors.red, borderRadius: 15, height: 25, width: 25, alignItems: 'center', justifyContent: 'center' }}>
                                            <Icon
                                                name='minus'
                                                size={10}
